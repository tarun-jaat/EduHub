...
function ForgotPassword(){
  ...
  return (
    ...
    <div className="grid min-h-[calc(100vh-3.5rem)] place-items-center bg-primary">
      ...
      { loading ? ( <div className="spinner"></div> ) : (
              ...
              <div className="max-w-[500px] p-4 lg:p-8">
                ...
                <form onSubmit = {handleOnSubmit}>
                  ...
                  <button type="submit" className="mt-6 w-full rounded-[8px] bg-secondary py-[12px] px-[12px] font-medium text-white"  > {!emailSent ? "Sumbit" : "Resend Email"}  </button>
