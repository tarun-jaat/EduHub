...
import { updateDisplayPicture } from "../../../Services/Operations/ServiceApi"
        ...
        <div className="flex items-center gap-x-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-row gap-3">
              ...
              <button onClick={handleClick} disabled={loading} className="cursor-pointer rounded-md bg-richblue-700 py-2 px-5 font-semibold text-richblack-50" >
                Select
              </button>
