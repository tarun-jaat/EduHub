...
import { updateProfile } from "../../../Services/Operations/ServiceApi"
  ...
  return (
    <>
      <form onSubmit={handleSubmit(submitProfileForm)}>
        ...
        {/* Profile Information */}
        <div className="my-2 flex flex-col gap-y-6 text-richblack-300 rounded-md border-[1px] border-richblack-700 bg-richblue-700 p-8 px-12">
        ...
        <div className="flex justify-center gap-2">
          <button onClick={() => {navigate("/dashboard/my-profile") }} className="cursor-pointer rounded-md bg-richblue-700 py-2 px-5 font-semibold text-richblack-50" >
            Cancel
          </button>
